...
# IMPORTAR EL COMPONENTE CUSTOM (debe estar en la raíz del repo)
try:
    from dnd_component import dnd_maquetador
except ImportError as e:
    st.error(f"❌ No se pudo importar el componente DnD. Asegúrate de que `dnd_component.py` y la carpeta `frontend/` estén en la raíz del repo. Error: {e}")
    st.stop()
...
# ==============================================================================
# 10. PROCESAR RETORNO DEL COMPONENTE
# ==============================================================================
if resultado_dnd:
    try:
        ...
        if evento_ts > st.session_state.ultimo_ts_procesado:
            ...
            for ofer in st.session_state.ofertas:
                if ofer["id_oferta"] == id_mod:
                    if nuevo_s is None or nueva_p is None:
...
# ==============================================================================
# 12. RESUMEN DE TODAS LAS PÁGINAS
# ==============================================================================
...
# ==============================================================================
# 13. GUARDAR EN SUPABASE — SIN TOCAR precio_oferta, TODAS LAS PÁGINAS
# ==============================================================================
if st.button("💾 Guardar Configuración Completa del Folleto", type="primary", use_container_width=True):
    ...
    for o in st.session_state.get("ofertas", []):
        ...
        if num_pag is not None and pos_slot is not None:
            ...
            num_cols_pag = calcular_layout_grid(config_pag.get("slots", slots_deseados))[2]
